...
void LoadUsers() {
    try {
        pqxx::connection C("dbname=dfqugt45bplafp user=ueid349f444hpc password=p115197e8dec98b7fd9d5e32e93fbe0a6911b95fd5fd837d7614dd97d031cfe75 host=caij57unh724n3.cluster-czrs8kj4isg7.us-east-1.rds.amazonaws.com port=5432 sslmode=require");

        if (C.is_open()) {
            std::cout << "Connected to the database successfully." << std::endl;

            pqxx::work W(C);
            pqxx::result R = W.exec("SELECT username, password, security_question, security_answer, last_sign_in, entry_count FROM users;");
